...
public class StudentPracticeController {
    ...
    public StudentPracticeController(PracticeService practiceService, StudentLearningService studentLearningService) {
    ...
    public String generatePractice(@RequestParam Long contentId,
                                   @RequestParam String difficulty,
                                   @RequestParam String questionType,
                                   @RequestParam int count,
                                   RedirectAttributes redirectAttributes) {
        try {
            PracticeSession session = practiceService.generatePracticeSession(demoStudentId, contentId, difficulty, questionType, count);
